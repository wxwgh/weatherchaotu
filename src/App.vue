<template>
	<div id="app" v-loading.fullscreen.lock="get_loading" element-loading-text="数据加载中" element-loading-spinner="el-icon-loading" element-loading-background="rgba(0, 0, 0, 0.5)">
		<!-- 页眉 -->
		<myheader></myheader>
		<!-- 主体部分 -->
		<mymain></mymain>
...
<script>
	...
	import myboot from '@/components/myboot.vue';
